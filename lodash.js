...
function rollNumber(list_num){
  for(var j, x, i = list_num.length; i; j = parseInt(Math.random() * i), x = list_num[--i], list_num[i] = list_num[j], list_num[j] = x);
  return list_num;
};
